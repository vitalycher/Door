...
class TipsGenerator {
    ...
    private let tips = [NSLocalizedString("You can open the glass door by saying 'Hello, Minutes!'", comment: ""),
                ...
                NSLocalizedString("Update the quote with 'New Quote' keyphrase c:", comment: ""),
                NSLocalizedString("New quote could be set by saying 'Quotation'", comment: ""),
                ...
                NSLocalizedString("You can set a new quote by saying 'Quote'.", comment: "")]
